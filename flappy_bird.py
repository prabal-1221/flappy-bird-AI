...
END_FONT = pygame.font.SysFont("comicscans", 70)
...
def draw_window_human(win, bird, pipes, base, score, pipe_ind):
    win.blit(BG_IMG, (0, -150))
...
def humanPlay():
    ...
    while run:
        ...
        if bird.y + bird.img.get_height() - 10 >= FLOOR:
            run = False
            pygame.quit()
            quit()

        draw_window_human(WIN, bird, pipes, base, score, pipe_ind)
